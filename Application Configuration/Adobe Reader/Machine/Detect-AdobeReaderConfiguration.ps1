<#
.SYNOPSIS
    This script is used to detect the current configuration of Adobe Reader on the machine. It is used in the Proactive Remediation process to determine if a remediation is needed.
.DESCRIPTION
    This script is used to detect the current configuration of Adobe Reader on the machine. It is used in the Proactive Remediation process to determine if a remediation is needed.
.NOTES
